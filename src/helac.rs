...
/// A mandatory comment
///
/// The information in the comment is stored as a String
...
///
/// The `# pdf` line in files generated for
///
/// * the real subtracted part
/// * the I-operator
/// * the LO+VIRTUAL part
...
pub struct DipMapInfo {
    ...
    /// that position).
    /// The values of the map are the positions of the particles in the
    /// `particles` list + 1, i.e. a 1 in the map corresponds to the
    /// particle at position 0 in the vector.
...
#[cfg_attr(test, derive(Serialize, Deserialize))]
pub struct JetInfo {
    /// One of the two partons merged into a jet
    pub ibvjet1: i8,
    /// The other parton merged into a jet
    pub ibvjet2: i8,
